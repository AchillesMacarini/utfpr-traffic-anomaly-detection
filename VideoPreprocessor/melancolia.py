...
video_path = "D:/UTFPR/TCC/AI-City Challenge/aic21-track4-train-data/2.mp4"
...
trajectories = {}
missing_frames = {}  # <-- mova para fora do loop principal
...
for _ in tqdm(range(total_frames), desc="Processing video"):
    ...
    if ret:
        ...
        if results[0].boxes.id is not None:
            ...
            # Atualize o contador de frames ausentes
            ...
            car_ids_to_remove = [car_id for car_id, count in missing_frames.items() if count > 30]  # aumente tolerância
